...
export default function Login({}) {
      ...
      .then((response) => {
        ...
        setLink(
          "https://firebasestorage.googleapis.com/v0/b/wherenext-24624.appspot.com/o/images%2F" +
            response.data.user.ProfilePicture.slice(81)
        );
  ...
  const handlePress = () => {
    ...
    axios
      .put("http://where-next.tech/users/profile", {
        uid: userUID.user.uid,
        ...
        name: nameInputValue,
        Birthdate:
          yInputValue + "-" + mInputValue + "-" + dInputValue + birthdate,
        region: region,
        telNo: telNo,
        profilePicture:
          "https://firebasestorage.googleapis.com/v0/b/wherenext-24624.appspot.com/o/images/" +
          link.slice(83),
        bio: bioInputValue,
      })
      .then((response) => {
      ...
      <View style={{ marginBottom: 200, width: "100%" }}>
        ...
        >
          ...
          <TouchableOpacity
            ...
            style={{ paddingTop: 10 }}
          >
            <Text style={{ color: "#3cb9ff", fontSize: 20 }}>Edit profile</Text>
          </TouchableOpacity>
        </View>
        <View
          style={{
        ...
        >
          ...
          <TextInput
            ...
            onChangeText={setSurnameInputValue}
            placeholderTextColor="#D8D8D8"
            style={{ color: "white", marginLeft: 20, fontSize: 20 }}
          />
        </View>
        ...
        >
          ...
          <TextInput
            ...
            placeholder="Bio"
            value={bioInputValue}
            onChangeText={setBioInputValue}
            placeholderTextColor="#D8D8D8"
            style={{ color: "white", marginLeft: 20, fontSize: 20 }}
          />
        </View>
        <View style={{ justifyContent: "center", alignItems: "center" }}>
          <Button label={"Save"} onPress={handlePress} style={{}}></Button>
        </View>
      </View>
    </View>
  );
...
const styles = StyleSheet.create({
  ...
  image: {
    ...
    height: 125,
    borderRadius: 100,
    marginTop: 40, // Half of the width and height to make it a circle
  },
});
