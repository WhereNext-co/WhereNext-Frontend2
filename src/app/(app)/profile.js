...
export default function Tab() {
  const [events,setEvents] =useState( ['00:00-04:00','06:00-08:00','12:00-18:00'] )
  const handlePress = () => {
  ...
  return (
    <View style={{flex: 1, justifyContent: 'flex-start', alignItems: 'center', backgroundColor: '#14072b'}}>
      <View style={{ alignItems: 'center',marginTop: 50,backgroundColor:'black',marginBottom: 40 }}>
          ...
          fontSize:20,
          padding:5, 
          color:'white'}}>Good ..., ...</Text>
          <Text style={{textAlign :"center",
          textAlignVertical:"bottom",
          fontSize:15,
          padding:10, 
          color:'white'}}>Today is ...,.........</Text>
        </View>
  ...
  <Button label={"icon"} onPress={handlePress} style={{marginLeft: 10}}></Button>
</View>
    </View>
  );
}
